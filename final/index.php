...
<body>
  ...
  <section>
    ...
    <div class="container mt-5 my-section">
      <h3 class="py-4">Manga 1</h3>
      <div class="row">

        <?php

        // FECTH PRODUCTS
        $sql = "SELECT * from products WHERE category='Manga 1' ORDER BY RAND() LIMIT 4";
        $query = $db->prepare($sql);
        $query->execute();
        $results = $query->fetchAll(PDO::FETCH_OBJ);
    ...
    <div class="container mt-5 my-section">
      <h3 class="py-4">Manga 2</h3>
      <div class="row">

        <?php

        // FECTH PRODUCTS
        $sql = "SELECT * from products WHERE category='Manga 2' ORDER BY RAND() LIMIT 4";
        $query = $db->prepare($sql);
        $query->execute();
        $results = $query->fetchAll(PDO::FETCH_OBJ);
    ...
    <div class="container mt-5 my-section">
      <h3 class="py-4">Manga 3</h3>
      <div class="row">

        <?php

        // FECTH PRODUCTS
        $sql = "SELECT * from products WHERE category='Manga 3' ORDER BY RAND() LIMIT 4";
        $query = $db->prepare($sql);
        $query->execute();
        $results = $query->fetchAll(PDO::FETCH_OBJ);
